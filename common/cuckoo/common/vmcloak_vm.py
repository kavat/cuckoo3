...
def GetCurrentGuacamoleVM():
  ...
  for row in rows:
    ...
    url = "http://{}:{}{}/#/client/{}?username={}&password={}".format(cfg("cuckoo.yaml", "guacamole", "web_ip"), cfg("cuckoo.yaml", "guacamole", "web_port"), cfg("cuckoo.yaml", "guacamole", "web_path"), client_id, cfg("cuckoo.yaml", "guacamole", "web_user"), cfg("cuckoo.yaml", "guacamole", "web_passwd"))
